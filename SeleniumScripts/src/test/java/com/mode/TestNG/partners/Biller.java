...
import com.mode.PageObjectRepository.partners.biller.BillerAdmin;
import com.mode.PageObjectRepository.partners.biller.BillerChecker;
import com.mode.PageObjectRepository.partners.biller.BillerMaker;
...
public class Biller {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, BillerMaker.class);
		maker.selectingBiller();
		Reporter.log("Selected Biller Menu", true);
	}
	...
	public void register()
		...
		maker.registerBiller(module_data[16][1],module_data[16][2]);
		Reporter.log("Biller record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[16][1], module_data[16][2]);
		Reporter.log("performed search based on Biller account", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[16][2]);
		Reporter.log("Updated Biller details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[16][2]);
		Reporter.log(" Biller Audit Log test case pass", true);
		Thread.sleep(1000);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[16][2]);
		Reporter.log(" Biller Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[16][1], module_data[16][2]);
		...
		Reporter.log("Biller record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, BillerChecker.class);
		checker.selectingBillerMenu(module_data[16][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[16][1], module_data[16][2]);
		Reporter.log("Biller record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[16][1], module_data[16][2]);
		Reporter.log("Biller record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, BillerAdmin.class);
		admin.selectingBillerMenu(module_data[16][2]);
		Reporter.log("Biller menu selected", true);
	...
	public void searchAdmin() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[16][1], module_data[16][2]);
		Reporter.log("performed search based on Biller acc no", true);
		Thread.sleep(2000);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[16][2]);
		Reporter.log("View Biller Successful", true);
