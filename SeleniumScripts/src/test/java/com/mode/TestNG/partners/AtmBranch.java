...
import com.mode.PageObjectRepository.partners.atmBranch.AtmBranchAdmin;
import com.mode.PageObjectRepository.partners.atmBranch.AtmBranchChecker;
import com.mode.PageObjectRepository.partners.atmBranch.AtmBranchMaker;
...
public class AtmBranch {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, AtmBranchMaker.class);
		maker.selectingAtmBranch();
		Reporter.log("Selected Atm Branch Menu", true);
	}
	...
	public void register()
		...
		maker.registerAtmBranch(module_data[26][1],module_data[26][2]);
		Reporter.log("Atm Branch record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[26][1], module_data[26][2]);
		Reporter.log("performed search based on name", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[26][2]);
		Reporter.log("Updated Atm Branch details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[26][2]);
		Reporter.log(" Atm Branch Audit Log test case pass", true);
		Thread.sleep(1000);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[26][2]);
		Reporter.log(" Atm Branch Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[26][1], module_data[26][2]);
		...
		Reporter.log("Atm Branch record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, AtmBranchChecker.class);
		checker.selectingAtmBranchMenu(module_data[26][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[26][1], module_data[26][2]);
		Reporter.log("Atm Branch record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[26][1], module_data[26][2]);
		Reporter.log("Atm Branch record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, AtmBranchAdmin.class);
		admin.selectingAtmBranchMenu(module_data[26][2]);
		Reporter.log("Atm Branch menu selected", true);
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[26][2]);
		Reporter.log("View Atm Branch Successful", true);
