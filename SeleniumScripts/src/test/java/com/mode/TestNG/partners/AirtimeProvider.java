package com.mode.TestNG.partners;
...
import com.mode.PageObjectRepository.partners.airtimeProvider.AirtimeProviderAdmin;
import com.mode.PageObjectRepository.partners.airtimeProvider.AirtimeProviderChecker;
import com.mode.PageObjectRepository.partners.airtimeProvider.AirtimeProviderMaker;
...
public class AirtimeProvider {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, AirtimeProviderMaker.class);
		maker.selectingAirtimeProvider();
		Reporter.log("Selected Airtime Provider Menu", true);
	}
	...
	public void register()
		...
		maker.registerProvider(module_data[17][1],module_data[17][2]);
		Reporter.log("Airtime Provider record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[17][1], module_data[17][2]);
		Reporter.log("performed search based on Airtime Provider account", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[17][2]);
		Reporter.log("Updated Airtime Provider details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[17][2]);
		Reporter.log(" Airtime Provider Audit Log test case pass", true);
		Thread.sleep(1000);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[17][2]);
		Reporter.log(" Airtime Provider Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[17][1], module_data[17][2]);
		...
		Reporter.log("Airtime Provider record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, AirtimeProviderChecker.class);
		checker.selectingProviderMenu(module_data[17][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[17][1], module_data[17][2]);
		Reporter.log("Airtime Provider record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[17][1], module_data[17][2]);
		Reporter.log("Airtime Provider record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, AirtimeProviderAdmin.class);
		admin.selectingAirtimeProviderMenu(module_data[17][2]);
		Reporter.log("Airtime Provider menu selected", true);
	...
	public void searchAdmin() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[17][1], module_data[17][2]);
		Reporter.log("performed search based on Airtime Provider acc no", true);
		Thread.sleep(2000);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[17][2]);
		Reporter.log("View Airtime Provider Successful", true);
