...
import com.mode.PageObjectRepository.jointAccount.accountRequest.AccountReqAdmin;
import com.mode.PageObjectRepository.jointAccount.accountRequest.AccountReqChecker;
import com.mode.PageObjectRepository.jointAccount.accountRequest.AccountReqMaker;
...
public class JAAccountRequest {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, AccountReqMaker.class);
		maker.selectingAccountReq();;
		Reporter.log("Selected Account_Request Menu", true);
	}
	...
	public void register()
		...
		maker.registerAccountReq(module_data[24][1],module_data[24][2]);
		Reporter.log("Account request record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[24][1], module_data[24][2]);
	...
	public void edit()
		...
		maker_methods.edit(module_data[24][2]);
		Reporter.log("Updated Account Request details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[24][2]);
		Reporter.log(" Account Request Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[24][2]);
		Reporter.log(" Account Request Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[24][1], module_data[24][2]);
		...
		Reporter.log("Account Request record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, AccountReqChecker.class);
		checker.selectingAccountReqMenu(module_data[24][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[24][1], module_data[24][2]);
		Reporter.log("Account Request Record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[24][1], module_data[24][2]);
		Reporter.log("Account Request Record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, AccountReqAdmin.class);
		admin.selectingCustomerMenu(module_data[24][2]);
		Reporter.log("Account Request menu selected", true);
	...
	public void searchAdmin()
		...
		maker_methods.search(module_data[24][1], module_data[24][2]);
		Reporter.log("Search Account Request successful", true);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[24][2]);
		Reporter.log("Account Request View Successful", true);
