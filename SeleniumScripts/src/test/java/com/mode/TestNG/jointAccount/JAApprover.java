package com.mode.TestNG.jointAccount;
...
import com.mode.PageObjectRepository.jointAccount.approver.JAApproverAdmin;
import com.mode.PageObjectRepository.jointAccount.approver.JAApproverChecker;
import com.mode.PageObjectRepository.jointAccount.approver.JAApproverMaker;
...
public class JAApprover {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, JAApproverMaker.class);
		maker.selectingjApprover();
		Reporter.log("Selected Joint Account Approver Menu", true);
	}
	...
	public void register()
		...
		maker.registerJApprover(module_data[25][1],module_data[25][2]);
		Reporter.log("Joint Account Approver record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[25][1], module_data[25][2]);
		Reporter.log("performed search based on Account Number", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[25][2]);
		Reporter.log("Updated Joint Account Approver details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[25][2]);
		Reporter.log(" Joint Account Approver Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[25][2]);
		Reporter.log(" Joint Account Approver Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[25][1], module_data[25][2]);
		...
		Reporter.log("Joint Account Approver record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, JAApproverChecker.class);
		checker.selectingJApproverMenu(module_data[25][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[25][1], module_data[25][2]);
		Reporter.log("Joint Account Approver Record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[25][1], module_data[25][2]);
		Reporter.log("Joint Account Approver Record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, JAApproverAdmin.class);
		admin.selectingJApproverMenu(module_data[25][2]);
		Reporter.log("Joint Account Approver menu selected", true);
	...
	public void searchAdmin()
		...
		maker_methods.search(module_data[25][1], module_data[25][2]);
		Reporter.log("Search Joint Account Approver successful", true);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[25][2]);
		Reporter.log("Joint Account Approver View Successful", true);
