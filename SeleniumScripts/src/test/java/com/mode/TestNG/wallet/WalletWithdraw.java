...
import com.mode.PageObjectRepository.wallet.withdrawal.WalletWithdrawalAdmin;
import com.mode.PageObjectRepository.wallet.withdrawal.WalletWithdrawalChecker;
import com.mode.PageObjectRepository.wallet.withdrawal.WalletWithdrawalMaker;
...
public class WalletWithdraw {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, WalletWithdrawalMaker.class);
		maker.selectingWithdrawalmenu();
		Reporter.log("Selected Wallet Withdraw Menu", true);
	}
	...
	public void withdraw()
		...
		maker.withdrawWalletAmount(module_data[21][1],module_data[21][2]);
		Reporter.log("Wallet Withdraw record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[21][1], module_data[21][2]);
	...
	public void edit()
		...
		maker_methods.edit(module_data[21][2]);
		Reporter.log("Updated Wallet Withdraw details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[21][2]);
		Reporter.log(" Wallet Withdraw Audit Log test case pass", true);
		Thread.sleep(1000);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[21][2]);
		Reporter.log(" Wallet Withdraw Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[21][1], module_data[21][2]);
		...
		Reporter.log("Wallet Withdraw record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, WalletWithdrawalChecker.class);
		checker.selectingWithdrawMenu(module_data[21][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[21][1], module_data[21][2]);
		Reporter.log("Wallet Withdraw record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[21][1], module_data[21][2]);
		Reporter.log("Wallet Withdraw record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, WalletWithdrawalAdmin.class);
		admin.selectingWithdrawMenu(module_data[21][2]);
		Reporter.log("Wallet Withdraw menu selected", true);
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[21][2]);
		Reporter.log("View Wallet Withdraw Successful", true);
