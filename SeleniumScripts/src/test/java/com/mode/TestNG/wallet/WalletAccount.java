...
import com.mode.PageObjectRepository.wallet.account.AccountAdmin;
import com.mode.PageObjectRepository.wallet.account.AccountChecker;
import com.mode.PageObjectRepository.wallet.account.AccountMaker;
...
public class WalletAccount {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, AccountMaker.class);
		maker.selectingAccountmenu();
		Reporter.log("Selected Wallet Account Menu", true);
	}
	...
	public void register()
		...
		maker.registerAccount(module_data[19][1],module_data[19][2]);
		Reporter.log("Wallet Account record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[19][1], module_data[19][2]);
		Reporter.log("performed search based on Wallet Account account", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[19][2]);
		Reporter.log("Updated Wallet Account details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[19][2]);
		Reporter.log(" Wallet Account Audit Log test case pass", true);
		Thread.sleep(1000);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[19][2]);
		Reporter.log(" Wallet Account Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[19][1], module_data[19][2]);
		...
		Reporter.log("Wallet Account record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, AccountChecker.class);
		checker.selectingAccountMenu(module_data[19][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[19][1], module_data[19][2]);
		Reporter.log("Wallet Account record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[19][1], module_data[19][2]);
		Reporter.log("Wallet Account record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, AccountAdmin.class);
		admin.selectingAccountMenu(module_data[19][2]);
		Reporter.log("Wallet Account menu selected", true);
	...
	public void searchAdmin() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[19][1], module_data[19][2]);
		Reporter.log("performed search based on Wallet Account acc no", true);
		Thread.sleep(2000);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[19][2]);
		Reporter.log("View Wallet Account Successful", true);
