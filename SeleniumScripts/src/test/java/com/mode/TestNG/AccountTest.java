...
import com.mode.PageObjectRepository.account.AccountAdmin;
import com.mode.PageObjectRepository.account.AccountChecker;
import com.mode.PageObjectRepository.account.AccountMaker;
...
public class AccountTest {
	...
	AccountMaker acc_maker;
	AccountChecker acc_checker;
	AccountAdmin acc_admin;
	...
	public void selectingMaker()
		...
		acc_maker = PageFactory.initElements(DriverClass.driver, AccountMaker.class);
		acc_maker.selectAccountMenu(module_data[5][2]);
		Reporter.log("Maker Account Menu selected", true);
	}
	...
	public void register()
		...
		acc_maker.registerAccount(module_data[5][1], module_data[5][2]);
		Reporter.log("Account Registration Successful", true);
	}
	...
	public void searchMaker()
		...
		maker_methods.search(module_data[5][1], module_data[5][2]);
	...
	public void edit()
		...
		maker_methods.edit(module_data[5][2]);
		Reporter.log("Updated Account details", true);
	}
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[5][2]);
		Reporter.log(" Account Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[5][2]);
		Reporter.log(" Account Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[5][1], module_data[5][2]);
		...
		Reporter.log("Account record submitted successfully", true);
	...
	public void selectChecker()
		...
		acc_checker = PageFactory.initElements(DriverClass.driver, AccountChecker.class);
		acc_checker.selectingAccountMenu(module_data[5][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[5][1], module_data[5][2]);
	...
	public void deny()
		...
		checker_methods.deny(module_data[5][1], module_data[5][2]);
		Reporter.log("Account Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		acc_admin = PageFactory.initElements(DriverClass.driver, AccountAdmin.class);
		acc_admin.selectingAccountMenu(module_data[5][2]);
		Reporter.log("Account menu selected", true);
		Thread.sleep(4000);
	}
	...
	public void searchAdmin()
		...
		maker_methods.search(module_data[5][1], module_data[5][2]);
		Reporter.log("Search Account successful", true);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[5][2]);
		Reporter.log("View Account Successful", true);
	}

	@Test
	public void blockAccount()
			throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException {
		admin_methods.block(module_data[5][2]);
		Reporter.log("Account blocked Successfully", true);
	}

	@Test
	public void unblockAccount()
			throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException {
		admin_methods.unblock(module_data[5][2]);
		Reporter.log("Account unblocked Successfully", true);
	}
