...
import com.mode.PageObjectRepository.configuration.chargeTypeRange.ChargeTypeAdmin;
import com.mode.PageObjectRepository.configuration.chargeTypeRange.ChargeTypeChecker;
import com.mode.PageObjectRepository.configuration.chargeTypeRange.ChargeTypeMaker;
...
public class ChargeTypeRange {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, ChargeTypeMaker.class);
		maker.selectingChargeType();
		Reporter.log("Selected Charge Type Menu", true);
	}
	...
	public void register()
		...
		maker.registerChargeType(module_data[13][1],module_data[13][2]);
		Reporter.log("Charge Type record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[13][1], module_data[13][2]);
	...
	public void edit()
		...
		maker_methods.edit(module_data[13][2]);
		Reporter.log("Updated Charge Type details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[13][2]);
		Reporter.log(" Charge Type Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[13][2]);
		Reporter.log(" Charge Type Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[13][1], module_data[13][2]);
		...
		Reporter.log("Charge Type record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, ChargeTypeChecker.class);
		checker.selectingChargeTypeMenu(module_data[13][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[13][1], module_data[13][2]);
		Reporter.log("Charge Type record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[13][1], module_data[13][2]);
		Reporter.log("Charge Type record Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, ChargeTypeAdmin.class);
		admin.selectingChargeTypeMenu(module_data[13][2]);
		Reporter.log("Charge Type menu selected", true);
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[13][2]);
		Reporter.log("View Charge Type Successful", true);

	}
	
	
	@Test
	public void resetApproval() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException{
		
		admin_methods.resetApproval(module_data[13][2]);
		Reporter.log("Charge Type Record Resent Successfully");
	}
