...
import com.mode.PageObjectRepository.customerMaintenance.custContactUpdate.CustUpdateAdmin;
import com.mode.PageObjectRepository.customerMaintenance.custContactUpdate.CustUpdateChecker;
import com.mode.PageObjectRepository.customerMaintenance.custContactUpdate.CustUpdateMaker;
...
public class CustomerInfoUpdate {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, CustUpdateMaker.class);
		maker.selectingCustInfo();
		Reporter.log("Selected Customer Info Update Menu", true);
	}
	...
	public void register()
		...
		maker.registerCustInfo(module_data[22][1],module_data[22][2]);
		Reporter.log("Customer Info Update record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[22][1], module_data[22][2]);
	...
	public void edit()
		...
		maker_methods.edit(module_data[22][2]);
		Reporter.log("Updated Customer Info Update details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[22][2]);
		Reporter.log(" Customer Info Update Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[22][2]);
		Reporter.log(" Customer Info Update Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[22][1], module_data[22][2]);
		...
		Reporter.log("Customer Info Update record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, CustUpdateChecker.class);
		checker.selectingCustomerInfoMenu(module_data[22][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[22][1], module_data[22][2]);
		Reporter.log("Customer Info Update record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[22][1], module_data[22][2]);
		Reporter.log("Customer Info Update record  Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, CustUpdateAdmin.class);
		admin.selectingCustomerInfoMenu(module_data[22][2]);
		Reporter.log("Customer Info Update menu selected", true);
	...
	public void searchAdmin()
		...
		maker_methods.search(module_data[22][1], module_data[22][2]);
		Reporter.log("Search Customer Info Update successful", true);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[22][2]);
		Reporter.log("View Customer Info Update record Successful", true);
