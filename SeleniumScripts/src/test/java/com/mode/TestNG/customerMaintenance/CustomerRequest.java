...
import com.mode.PageObjectRepository.customerMaintenance.customerRequest.CustomerReqAdmin;
import com.mode.PageObjectRepository.customerMaintenance.customerRequest.CustomerReqChecker;
import com.mode.PageObjectRepository.customerMaintenance.customerRequest.CustomerReqMaker;
...
public class CustomerRequest {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, CustomerReqMaker.class);
		maker.selectingCustReq();
		Reporter.log("Selected Customer_Request Menu", true);
	}
	...
	public void register()
		...
		maker.registerCustReq(module_data[10][1],module_data[10][2]);
		Reporter.log("Customer request record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[10][1], module_data[10][2]);
		Reporter.log("performed search based on Mobile Number", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[10][2]);
		Reporter.log("Updated CustomerRequest details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[10][2]);
		Reporter.log(" Customer Request Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[10][2]);
		Reporter.log(" Customer Request Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[10][1], module_data[10][2]);
		...
		Reporter.log("Customer Request record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, CustomerReqChecker.class);
		checker.selectingCustomerMenu(module_data[10][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[10][1], module_data[10][2]);
		Reporter.log("Customer Request record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[10][1], module_data[10][2]);
		Reporter.log("Customer Request record  Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, CustomerReqAdmin.class);
		admin.selectingCustomerMenu(module_data[10][2]);
		Reporter.log("Customer Request menu selected", true);
	...
	public void searchAdmin()
		...
		maker_methods.search(module_data[10][1], module_data[10][2]);
		Reporter.log("Search Customer Request successful", true);
	}
	...
	public void view()
		...
		Reporter.log("View Customer Request record Successful", true);
