package com.mode.TestNG.customerMaintenance;
...
import com.mode.PageObjectRepository.customerMaintenance.doNotDisturb.DoNotDisturbAdmin;
import com.mode.PageObjectRepository.customerMaintenance.doNotDisturb.DoNotDisturbChecker;
import com.mode.PageObjectRepository.customerMaintenance.doNotDisturb.DoNotDisturbMaker;
...
public class DonotDisturb {
	...
	public void selectingMaker()
		...
		maker = PageFactory.initElements(DriverClass.driver, DoNotDisturbMaker.class);
		maker.selectingDoNotDisturbMenu();
		Reporter.log("Selected Do Not Disturb Timing Menu", true);
	}
	...
	public void register()
		...
		maker.registerDoNotDisturb(module_data[23][1],module_data[23][2]);
		Reporter.log("Do Not Disturb Timing record is created ", true);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[23][1], module_data[23][2]);
		Reporter.log("performed search based on CIF Number", true);
		Thread.sleep(2000);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[23][2]);
		Reporter.log("Updated Do Not Disturb Timing details", true);
		Thread.sleep(2000);
	}
	@Test
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[23][2]);
		Reporter.log(" Do Not Disturb Timing Audit Log test case pass", true);
	}
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[23][2]);
		Reporter.log(" Do Not Disturb Timing Approval History test case pass", true);
	}
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[23][1], module_data[23][2]);
		...
		Reporter.log("Do Not Disturb Timing record submitted successfully", true);
	...
	public void selectChecker()
		...
		checker = PageFactory.initElements(DriverClass.driver, DoNotDisturbChecker.class);
		checker.selectingDoNotDisturbMenu(module_data[23][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[23][1], module_data[23][2]);
		Reporter.log("Do Not Disturb Timing record Approved", true);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[23][1], module_data[23][2]);
		Reporter.log("Do Not Disturb Timing record  Rejected", true);
	}

	@Test
	public void selectAdmin()
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		admin = PageFactory.initElements(DriverClass.driver, DoNotDisturbAdmin.class);
		admin.selectingDoNotDisturbMenu(module_data[23][2]);
		Reporter.log("Do Not Disturb Timing menu selected", true);
	...
	public void searchAdmin()
		...
		maker_methods.search(module_data[23][1], module_data[23][2]);
		Reporter.log("Search Do Not Disturb Timing successful", true);
	}
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[23][2]);
		Reporter.log("View Do Not Disturb Timing record Successful", true);
