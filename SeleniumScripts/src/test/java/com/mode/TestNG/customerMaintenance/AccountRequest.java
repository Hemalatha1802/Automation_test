...
import com.mode.PageObjectRepository.customerMaintenance.accountRequest.AccountReqAdmin;
import com.mode.PageObjectRepository.customerMaintenance.accountRequest.AccountReqChecker;
import com.mode.PageObjectRepository.customerMaintenance.accountRequest.AccountReqMaker;
...
public class AccountRequest {
	...
	public void register()
		...
		maker.registerAccountReq(module_data[11][1],module_data[11][2]);
	...
	public void searchMaker() throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException{
		...
		maker_methods.search(module_data[11][1], module_data[11][2]);
	...
	public void edit()
		...
		maker_methods.edit(module_data[11][2]);
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[11][2]);
	...
	public void approvalHistory()
		...
		maker_methods.approvalHistory(module_data[11][2]);
	...
	public void submitRecord() throws InterruptedException {
		...
		try {
			maker_methods.submitRecord(module_data[11][1], module_data[11][2]);
	...
	public void selectChecker()
		...
		checker.selectingAccountReqMenu(module_data[11][2]);
	...
	public void approve()
		...
		checker_methods.approve(module_data[11][1], module_data[11][2]);
	...
	public void deny()
			throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException {
		checker_methods = PageFactory.initElements(DriverClass.driver, CommonCheckerMethods.class);
		checker_methods.deny(module_data[11][1], module_data[11][2]);
	...
	public void selectAdmin()
		...
		admin.selectingCustomerMenu(module_data[11][2]);
	...
	public void view()
		...
		admin_methods.viewRecord(module_data[11][2]);
