...
import com.mode.PageObjectRepository.globalConfiguration.InterfacePermissions;
...
public class InterfacePermission {
	...
	ExcelLib excel;
	String[][] module_data;
	InterfacePermissions permission;
	...
	@Test
	public void addInterfacePermission()
			throws EncryptedDocumentException, InvalidFormatException, InterruptedException, IOException {

		permission = PageFactory.initElements(DriverClass.driver, InterfacePermissions.class);
		permission.addInterfacePermissionRecord(module_data[34][2]);
		Reporter.log("Interface Permission record created successfully", true);
	}
	...
	public void searchMaker()
		...
		maker_methods.search(module_data[34][1], module_data[34][2]);
		Reporter.log("performed search based on Interface ", true);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[34][2]);
		Reporter.log("Updated Interface Permission details", true);
	}
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[34][2]);
		Reporter.log("Interface Permission Audit Log test case pass", true);
	}
