...
import com.mode.PageObjectRepository.globalConfiguration.MessageTemplate;
...
public class MessageTemplateTest {
	...
	public void registerTemplate()
		...
		msg_temp = PageFactory.initElements(DriverClass.driver, MessageTemplate.class);
		msg_temp.createMessageTemplate(module_data[32][2]);
		Reporter.log("Message Template created successfully", true);
	}
	...
	public void searchMaker()
		...
		maker_methods.search(module_data[32][1], module_data[32][2]);
		Reporter.log("performed search based on code", true);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[32][2]);
		Reporter.log("Updated Message Template details", true);
	}
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[32][2]);
		Reporter.log("Message Template Audit Log test case pass", true);
	}
