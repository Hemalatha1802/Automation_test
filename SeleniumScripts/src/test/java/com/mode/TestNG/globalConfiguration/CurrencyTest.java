...
import com.mode.PageObjectRepository.globalConfiguration.Currency;
...
public class CurrencyTest {
	...
	public void createCurrencyRecord()
		...
		currency = PageFactory.initElements(DriverClass.driver, Currency.class);
		currency.createCurrency(module_data[35][2]);
		Reporter.log("Currency record created successfully", true);
	}
	...
	public void searchMaker()
		...
		maker_methods.search(module_data[35][1], module_data[35][2]);
		Reporter.log("performed search based on Currency code", true);
	}
	...
	public void edit()
		...
		maker_methods.edit(module_data[35][2]);
		Reporter.log("Updated Currency details", true);
	}
	...
	public void auditLog()
		...
		maker_methods.audit(module_data[35][2]);
		Reporter.log("Currency Audit Log test case pass", true);
	}
