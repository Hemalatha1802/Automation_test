...
public class WalletDepositChecker extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='checkerdeposit.jsp']")
	...
	public void selectingDepositMenu(String module_name) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
