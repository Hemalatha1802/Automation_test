...
public class WalletWithdrawalMaker extends DriverClass {
	...
	@FindBy(xpath = "//div[@href='makerwithdrawl.jsp']")
	private WebElement withdrawal_menu;
	...
	// Code to select Withdrawal Menu under Wallet
	public void selectingWithdrawalmenu()
		...
		wait.until(ExpectedConditions.visibilityOf(withdrawal_menu)).click();
		Thread.sleep(1000);
	...
	//Code to Withdraw Wallet Amount
	public void withdrawWalletAmount(String sheet_name, String module_name)
			throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
		getAdd_btn().click();
