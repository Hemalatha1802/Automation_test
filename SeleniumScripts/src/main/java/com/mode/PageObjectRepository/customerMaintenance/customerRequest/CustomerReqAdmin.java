...
public class CustomerReqAdmin extends DriverClass {
	...
	@FindBy(xpath = "//div[@href='admincustrequest.jsp']")
	private WebElement custReq_menu;
	...
	public WebElement getCustReq_menu() {
		return custReq_menu;
	}

	// Code to select Customer Request Menu under admin
	public void selectingCustomerMenu(String module_name)
		...
		wait.until(ExpectedConditions.visibilityOf(custReq_menu)).click();
		Thread.sleep(1000);
	}
}
