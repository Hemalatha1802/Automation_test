...
public class ServicePermissionsAdmin extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='adminservicepermissions.jsp']")
	private WebElement service_permission;

	
	
	
	// Code to select Service Permission Menu under admin
	public void selectingServicePermissionMenu(String module_name)
