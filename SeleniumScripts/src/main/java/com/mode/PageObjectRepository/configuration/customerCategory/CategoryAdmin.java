...
public class CategoryAdmin extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='admincustomercat.jsp']")
	private WebElement cust_cat;

	
	
	
	// Code to select Customer Category Request Menu under admin
	public void selectingCustCategoryMenu(String module_name)
