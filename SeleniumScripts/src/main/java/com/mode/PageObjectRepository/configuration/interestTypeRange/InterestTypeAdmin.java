...
public class InterestTypeAdmin extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='admininterestrates.jsp']")
	private WebElement cust_cat;

	
	
	
	// Code to select Interest Type Range Menu under admin
	public void selectingInterestTypeMenu(String module_name)
