...
public class CategoryChecker extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='checkercustomercat.jsp']")
	...
	// Code to select Customer Category Request Menu under Checker
	public void selectingCustCategoryMenu(String module_name) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
