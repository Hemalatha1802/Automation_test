...
public class ServicePermissionsChecker extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='checkerservicepermissions.jsp']")
	...
	// Code to select Service Permission Menu under Checker
	public void selectingServicePermissionMenu(String module_name) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
