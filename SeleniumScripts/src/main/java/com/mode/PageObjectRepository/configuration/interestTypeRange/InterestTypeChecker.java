...
public class InterestTypeChecker extends DriverClass{
	...
	@FindBy(xpath = "//div[@href='checkerinterestrates.jsp']")
	...
	// Code to select Interest Type Range Menu under Checker
	public void selectingInterestTypeMenu(String module_name) throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException {
